...
def retieveData(infile_name1, group_fields, agg_fields, 
    ...
    flow_nums = [x[0] for x in df1.index.values]
...
if __name__ == "__main__":
    ...
    pair_seq = 13
    accuracyPlot(topo_types, task_types, trace_types[3:7], pair_seq=pair_seq)
    rankingPlot(topo_types, task_types, trace_types[3:7], pair_seq=pair_seq)
