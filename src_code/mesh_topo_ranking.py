        ...
        for line in f:
            ...
            if(len(flow_dict) < 1824763):
                ...
                while(data_size > 0):
                    ...
                    if drop_id == 0 and w_key not in byte_dict_from_file:
                    ...
                    send_packet(
                        ...
                        w_key=byte_dict_from_file[w_key]
                    )
                    data_size -= per_size
...
def single(r1, r2, pairs, est_pairs, switch_nodes, 
    ...
    return trues, ests, select_len, est_pairs, true_class,  exc_time, app_exc_time
...
if __name__ == "__main__":
    ...
    for (r1, r2) in test_pairs:
        ...
        if r1 != r2:
            key = '-'.join(sorted([r1, r2]))
            trues, ests, select_len, est_pairs, true_class_dict[key], exc_time, app_exc_time = single(
    ...
    classification_alg(true_byte_dict, epsilon=epsilon_p, epsilon_pb=epsilon_b)
